...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Qu\u1EA3n l\u00FD b\u00E0i vi\u1EBFt trang Tri Th\u1EE9c';
    displayName: 'Tri th\u1EE9c (Articles)';
    pluralName: 'articles';
...
export interface ApiCeoProfileCeoProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    annualRevenue: Schema.Attribute.Enumeration<
      [
        'Ch\u01B0a c\u00F3 doanh thu',
        'D\u01B0\u1EDBi 5 t\u1EF7 VND',
        'T\u1EEB 5 t\u1EF7 \u0111\u1EBFn 20 t\u1EF7 VND',
        'T\u1EEB 20 t\u1EF7 \u0111\u1EBFn 100 t\u1EF7 VND',
        'T\u1EEB 100 t\u1EF7 \u0111\u1EBFn 500 t\u1EF7 VND',
        'Tr\u00EAn 500 t\u1EF7 VND',
      ]
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    employeeCount: Schema.Attribute.Enumeration<
      [
        'Kh\u00F4ng qu\u00E1 10 ng\u01B0\u1EDDi',
        'T\u1EEB 11-50 ng\u01B0\u1EDDi',
        'T\u1EEB 51-100 ng\u01B0\u1EDDi',
    ...
    > &
      Schema.Attribute.Private;
    managementExperience: Schema.Attribute.Enumeration<
      [
        'D\u01B0\u1EDBi 1 n\u0103m',
        'T\u1EEB 1-5 n\u0103m',
        'T\u1EEB 5-10 n\u0103m',
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Qu\u1EA3n l\u00FD s\u1EF1 ki\u1EC7n / ch\u01B0\u01A1ng tr\u00ECnh';
    displayName: 'Ch\u01B0\u01A1ng tr\u00ECnh (Events)';
    pluralName: 'events';
    singularName: 'event';
  };
  options: {
